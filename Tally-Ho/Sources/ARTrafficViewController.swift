...
class ARTrafficViewController: UIViewController {
    ...
    private func appendToHUDLog(reason: String, rawFrames: [String] = []) {
        ...
        if let s = d.calibrationV7Status    { cal.append(s) }
        if let s = d.calibration47bV3Status { cal.append(s) }
        if let s = d.calibration43bV1Status { cal.append(s) }
        if let s = d.calibrationV8Status    { cal.append(s) }
        if let s = d.calibration47bV4Status { cal.append(s) }
        ...
        if let s = d.calibration47bV7Status  { cal.append(s) }
        if let s = d.calibration47bV8Status  { cal.append(s) }
        if let s = d.calibrationV11Status    { cal.append(s) }
        if let s = d.calibration56bV2Status  { cal.append(s) }
        if let s = d.calibrationV12Status    { cal.append(s) }
        if let s = d.calibration56bV3Status  { cal.append(s) }
        if let s = d.calibration56bV4Status  { cal.append(s) }
        if let s = d.calibration56bV5Status  { cal.append(s) }
        if let s = d.calibration56bV6Status  { cal.append(s) }
        if let s = d.calibration22bV13Status { cal.append(s) }
        ...
        if !d.capturedV7FrameHex.isEmpty       { cal.append("decoded22v7: \(d.capturedV7FrameHex)") }
        if !d.captured47bV3Hex.isEmpty         { cal.append("decoded47b-v3: \(d.captured47bV3Hex)") }
        if !d.captured43bV1Hex.isEmpty         { cal.append("decoded43b-v1: \(d.captured43bV1Hex)") }
        if !d.capturedV8FrameHex.isEmpty       { cal.append("decoded22v8: \(d.capturedV8FrameHex)") }
        if !d.captured47bV4Hex.isEmpty         { cal.append("decoded47b-v4: \(d.captured47bV4Hex)") }
        ...
        if !d.captured47bV7Hex.isEmpty         { cal.append("decoded47b-v7: \(d.captured47bV7Hex)") }
        if !d.captured47bV8Hex.isEmpty         { cal.append("decoded47b-v8: \(d.captured47bV8Hex)") }
        if !d.capturedV11FrameHex.isEmpty      { cal.append("decoded22v11: \(d.capturedV11FrameHex)") }
        if !d.captured56bV2Hex.isEmpty         { cal.append("decoded56b-v2: \(d.captured56bV2Hex)") }
        if !d.capturedV12FrameHex.isEmpty      { cal.append("decoded22v12: \(d.capturedV12FrameHex)") }
        if !d.captured56bV3Hex.isEmpty         { cal.append("decoded56b-v3: \(d.captured56bV3Hex)") }
        if !d.captured56bV4Hex.isEmpty         { cal.append("decoded56b-v4: \(d.captured56bV4Hex)") }
        if !d.captured56bV5Hex.isEmpty         { cal.append("decoded56b-v5: \(d.captured56bV5Hex)") }
        if !d.captured56bV6Hex.isEmpty         { cal.append("decoded56b-v6: \(d.captured56bV6Hex)") }
        if !d.captured22bV13Hex.isEmpty        { cal.append("decoded22v13: \(d.captured22bV13Hex)") }
